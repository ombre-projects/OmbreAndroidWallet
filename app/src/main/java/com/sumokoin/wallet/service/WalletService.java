...
package com.sumokoin.wallet.service;
...
import com.sumokoin.wallet.WalletActivity;
import com.sumokoin.wallet.model.PendingTransaction;
import com.sumokoin.wallet.model.Wallet;
import com.sumokoin.wallet.model.WalletListener;
...
public class WalletService extends Service {
    ...
    private boolean start(String walletName, String walletPassword) {
        ...
        if (listener == null) {
            ...
            if (aWallet == null) {
                Timber.d("Could not load wallet");
            }
            if (aWallet.getConnectionStatus() != Wallet.ConnectionStatus.ConnectionStatus_Connected) {
